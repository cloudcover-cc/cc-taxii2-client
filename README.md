...
>>> connection = CCTaxiiClient("test_account", "XxXxXx")
>>> connection
CCTaxiiClient(account='test_account', url='https://taxii2.cloudcover.net', headers={'Accept': 'application/taxii+json;version=2.1', 'Content-Type': 'application/taxii+json;version=2.1', 'Authorization': 'Basic dGVzdF9hY2NvdW50Olh4WHhYeA=='})
>>>
...
711
>>> 
>>> generate_indicators = connection.get_cc_indicators_generator(private=True, limit=2, follow_pages=True)
